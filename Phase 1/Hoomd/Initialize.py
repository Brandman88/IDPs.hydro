...
execute_shell_command_start("conda deactivate")
execute_shell_command("module load anaconda/anaconda3 && source activate hoomd && source $HOME/my-envs/uber_env/bin/activate && module load anaconda/anaconda3 && python3 organize.py")
execute_shell_command_start("conda deactivate")
