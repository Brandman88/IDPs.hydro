...
# Define the commands
commands = [
    'module load anaconda/anaconda3 && source activate hoomd && source $HOME/my-envs/uber_env/bin/activate && python3 organize.py',
    'module load anaconda/anaconda3 && source activate hoomd && source $HOME/my-envs/uber_env/bin/activate && python3 ProteinBulk.py',
    'module load anaconda/anaconda3 && source activate hoomd && source $HOME/my-envs/uber_env/bin/activate && python3 long_config_analysis.py',
    'module load anaconda/anaconda3 && source activate hoomd && source $HOME/my-envs/uber_env/bin/activate && python3 cm_fix.py',
    'module load anaconda/anaconda3 && source activate hoomd && source $HOME/my-envs/uber_env/bin/activate && python3 organize.py'
]
