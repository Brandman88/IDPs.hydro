...
# Define the commands
commands = [
    'module load anaconda/anaconda3 && source activate hoomd && conda activate uber_env && python3.8 organize.py',
    'module load anaconda/anaconda3 && source activate hoomd && conda activate uber_env && module load anaconda/anaconda3 && python3.8 SOP_IDP2.py',
    'module load anaconda/anaconda3 && source activate hoomd && conda activate uber_env && module load anaconda/anaconda3 && python3.8 long_config_analysis.py',
    'module load anaconda/anaconda3 && source activate hoomd && conda activate uber_env && module load anaconda/anaconda3 && python3.8 cm_fix.py',
    'module load anaconda/anaconda3 && source activate hoomd && conda activate uber_env && python3.8 organize.py'
]
